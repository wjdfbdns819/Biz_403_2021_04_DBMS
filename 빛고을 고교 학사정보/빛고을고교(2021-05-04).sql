-- 여기는 kscuser 접속화면
-- tbl_student, tbl-dept, tbl_subject, tbl_score 생성
...
-- LEFT JOIN을 하여 improt된 두 테이블간의 데이터 유효성 검증
...
-- 제 2정규화 되어 있는 Table의 데이터를
--  PIVOT하여 일반적인 보고서 List 형태로 만드는 코드
