...
CREATE TABLE tbl_iolist (
    io_date VARCHAR2(10), -- 날짜 (2021-04-21
...
-- 데이터가 INSERT 되어버렸다
-- 나중에 확인을 해보니 상품이 없어서 데이터 활용 가치가
-- 매우 떨어지는 현상이 발생했다
...
-- 데이터를 INSERT 하는데  필수적으로 settion 되어야 할 칼럼에
--  필수 제약조건을 설정하자

DROP TABLE tbl_iolist;

CREATE TABLE tbl_iolist (
    io_date VARCHAR2(10) NOT NULL, -- 날짜 (2021-04-21
...
FROM tbl_iolist; -- ioilstDB.iouse.tbl_iolist 에서 데이터를 가져와라
