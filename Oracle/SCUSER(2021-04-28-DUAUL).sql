...
-- 일반적인 코딩과 달리 정수 부분도 반올림 연산을 수행할수 있다
SELECT ROUND(555,-1),
        ROUND(555,-2),
        ROUND(555,-3)
        FROM DUAL;
...
--  변환하여 연산을 수행한다
-- 자동 형변환은 예상하지 못하는 연산결과를 얻을 수 있다
SELECT '30' + '40' FROM DUAL;

-- 날짜와 시간데이터에 ROUND를 입히기
-- 보이는 것과 달리 실제 데이터는 2021-04-28:00:00:00 형식으로 ROUND가 적용된다
SELECT 
