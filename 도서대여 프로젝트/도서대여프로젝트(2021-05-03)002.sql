...
PK(PRIMARY KEY)
 데이터 개체 무결성을 보장하기 위한 제약조건
  ...
  하기 위한 제약조건
  UPDATE...WHERE PK 칼럼 = '값';
  DELETE...WHERE PK 칼럼 = '값';
...
FK(FOREIGN KEY)
 ...
 Master에 없는 데이터가 Work에 존재하는 것을 막는 사전조치
  FK = 참조무결성, Work에 저장된 데이터는 의미없는 것이 없다
*/